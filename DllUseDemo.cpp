...
BOOL CDllUseDemoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDllUseDemoDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CDllUseDemoView));
	if (!pDocTemplate)
		return FALSE;
...
// 用于运行对话框的应用程序命令
void CDllUseDemoApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CDllUseDemoApp 自定义加载/保存方法

void CDllUseDemoApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDllUseDemoApp::LoadCustomState()
{
}

void CDllUseDemoApp::SaveCustomState()
{
}
